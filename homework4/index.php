      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h5 class="w3-opacity"><b><?php echo $expiriens[$i]["name"]?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $expiriens[$i]["beginDate"]?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $expiriens[$i]["endDate"]?></span></h6>
            <p><?php echo $expiriens[$i]["description"]?></p>
            <hr>
            <?php endfor;?>
          </div>
        </div>
